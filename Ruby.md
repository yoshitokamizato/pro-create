...
2.[Atom](https://eng-entrance.com/atom-editor)

[Atomのインストール](https://atom.io/)

3.[Vs code   (Visual Studio Code)](https://hirata.blog/201807_vs-code-introduction/)

[Vs codeのインストール](https://code.visualstudio.com/download)

# 文、式、コメント
1.[式展開](https://www.pikawaka.com/ruby/formula-expand/)

2.[ヒアドキュメント](https://tomoyuki65.com/how-to-use-heredoc-in-ruby/)

# 条件分岐処理
1.[条件分岐処理とは](https://wa3.i-3-i.info/word15415.html)

# 繰り返し
1.[eachメソッド](https://uxmilk.jp/22095)

# ハッシュ（Hash）クラス
1.[ハッシュの使いかた](https://www.pikawaka.com/ruby/hash)

# 条件判断
1.[if文](https://wa3.i-3-i.info/word11654.html)

# 配列
1.[Rubyの配列とは](https://code-schools.com/ruby2/)
